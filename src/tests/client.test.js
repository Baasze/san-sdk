 ...
 * @LastEditTime: 2020-07-03 19:26:55
 * @LastEditors: kay
 */
...
describe('ICFS Client', function(){
  ...
  //     content: 'test'
  //   }
  //   // var res = await client.addUrl('https://www.baidu.com')
  //   // console.log(res)
  //   res = await client.add(test)
  //   console.log(res)
  // }, 3000)
  // icfs add
  // it('add test', async function () {
  ...
  //   var fileCid
    ...
    // fileWithNameCid = await client.add({path: 'a.txt', content: 'a'}, 'a.txt')
